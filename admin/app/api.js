...
// Each module shapes the speaker/TuneIn responses into the structures
// app/state.js expects. See admin/PLAN.md § REST API.
//
// 0.2 slice 6 adds: speaker-proxy reads (now_playing) + XML parser.
// Slices 2/4/5 will extend with TuneIn search/browse and presets.
...
// Returns null on transport error so callers can keep showing the
// previous state instead of clobbering the UI with a blank header.
